...
const GardenId: React.FC = () => {
    ...
    return (
        <>
        <div className="gardenid-hero">
            <NavBarDesktop />
            <NavBarMobile />

            <div className="garden-banner w-full h-45 lg:h-75 relative flex items-center justify-center">
                <img
                    src={bannerImage}
                    alt={garden.name}
                ...
                <button
                    ...
                    className="absolute top-4 lg:top-20 left-4 z-20 flex items-center gap-1 bg-white/30 backdrop-blur-sm hover:bg-white/50 text-white rounded-full p-2 transition"
                >
                    <FiArrowLeft size={20} />
